...
$options = array(
    'general' => array(
        ...
        array("name" => "Mobile Logo",
            "desc" => "Size: max-width=220px, max-height=48px",
            "id" => "mobilelogo",
            "std" => "",
            "type" => "text",
            "btn" => true),
...
//        ),
        array("type" => "open"),
        array("name" => "Bài viết nổi bật",
            "desc" => "",
            "id" => "constructions_cat",
            "std" => "",
            "type" => "select",
...
//            "type" => "text"),
        ...
        array("name" => "Video Youtube",
            "desc" => "Dán đoạn mã nhúng của Youtube vào đây. Kích thước 500 x 450",
            "id" => SHORT_NAME . "_video",
            "std" => '',
            "type" => "textarea"),
        array("name" => "Contact Form 7",
            "desc" => 'Dán đoạn mã của contact form 7 vào đây. Ví dụ: [contact-form-7 id="81" title="Contact form 1"]',
            "id" => SHORT_NAME . "_form",
            "std" => '',
            "type" => "text"),
...
//            "desc" => "",
//            "id" => SHORT_NAME . "_pageShippingPolicy",
//            "std" => '',
//            "type" => "select",
//            "options" => $page_list),
//        array("name" => "Phương thức thanh toán",
//            "desc" => "",
//            "id" => SHORT_NAME . "_pagePaymentMethod",
//            "std" => '',
//            "type" => "select",
//            "options" => $page_list),
//        array("type" => "close"),
