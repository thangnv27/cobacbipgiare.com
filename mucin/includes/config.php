...
//            "std" => '',
//            "type" => "text"),
        array("name" => "Link website",
            "desc" => "Ví dụ: Link website",
            "id" => "link_website",
            "std" => "",
            "type" => "text"),
        array("name" => "Thông tin footer",
            "desc" => "Thông tin footer",
            "id" => SHORT_NAME . "_footer_info",
            "std" => '',
            "type" => "textarea",
            "editor" => array(
                'wyswig' => true,
    ...
    'theme-options' => array(
        ...
        array("name" => "Phân trang sản phẩm",
            "desc" => "Số lượng sản phẩm hiển thị trên 1 trang. Ví dụ: 8",
